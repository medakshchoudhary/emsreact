...
const CreateTask = () => {
  return (
    <div className='w-full text-white bg-zinc-800 flex p-5 rounded-md mt-3'>
        ...
        <div className="right w-1/2">
            <div>
                ...
                <textarea className='w-full p-2 h-[25vh] bg-transparent outline-none border-2 rounded' name="" id=""></textarea>
