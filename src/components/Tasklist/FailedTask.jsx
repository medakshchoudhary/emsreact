...
const FailedTask = () => {
  return (
    <div className='taskcard flex-shrink-0 p-8 w-[24vw] h-[45vh] bg-red-400 rounded-lg'>
        ...
        <button className='w-full bg-red-600 px-2 py-1 rounded-md mt-4 hover:bg-red-700'>Failed</button>
      </div>
  )
}
